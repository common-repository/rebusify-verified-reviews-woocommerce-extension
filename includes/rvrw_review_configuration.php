...
if (rvrw_exist_option('rbs_serial_key')) {
    ...
    // update rbs_new_serial_key also
    if (rvrw_exist_option('rbs_new_serial_key')) {
        update_option('rbs_new_serial_key', $rbs_serial_key);
        } else {
        add_option('rbs_new_serial_key', $rbs_serial_key);
        }
}
...
$new_serial_key="";
if (rvrw_exist_option('rbs_new_serial_key')) {
              $new_serial_key=          get_option('rbs_new_serial_key');
    }
...
<?php if (isset($message)) echo '<p style="color:red">' . $message . '</p>'; ?> 
        ...
        <p>
            ...
            You will need a Serial Key so please register below or visit <a href="https://reviews.trustalyze.com/plans/" target="_blank">Trustalyze.com</a> to get your serial key.</p>
    </div>
    <?php
    if (!rvrw_exist_option('rbs_new_serial_key')) {  ?>
    ...
    <form action="" method="POST">
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td><input <?php if ($enableReview == 1 || $check_enable_review==1) echo 'checked'; ?> value="1" type="checkbox" name="chk_enable"/>Enable Trustalyze Reviews </td>
            </tr>
            <tr valign="top">
                ...
                <td class="forminp forminp-text">
                    ...
                    <input required="" type="email" value="<?php if($rbs_email!="" ) { echo $rbs_email; } else if(isset($email)) echo $email; ?>" name="txt_email"/>
                </td>
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-text">
                    ...
                    <input required="" type="text" value="<?php if($rbs_serial_key!="") echo $rbs_serial_key; else if($new_serial_key!="") echo $new_serial_key; ?>" name="txt_apikey"/>
                </td>
...
<div style="display:none;" id="browseArea"  class="rvrw-advanced-modal-popup">
                    <div class="rvrw-advanced-modal-content-popup bigpopup">
                        <div class="rvrwpopupheader">
                            <span class="rvrwlogo">
                        ...
                        <div class="rvrw-advanced-modal-body-popup align-left">
                            ...
                            <div id="rvrwbrowseAreaInner">
                                ...
                                <div class="rvrwrgsdv">
                                     ...
                                     <input disabled="" type="text" name="txt_weburl" value="<?php echo $siteurl ?>" placeholder="Put the full URL of your website i.e. https://reviews.trustalyze.com"  required/>
                                </div> 
                                <div class="rvrwrgsdv">
                                     <label>About Company&nbsp;<abbr class="required" title="required">*</abbr></label><br>
                                     <input type="text" maxlength="250" placeholder="Please tell us about your company. 250 Character Limit." name="txt_about_company" value="<?php if(isset($about_company)) echo $about_company;?>" required/>
                                </div>
                                <div class="rvrwrgsdv">
                                     <label>Site Keyword&nbsp;<abbr class="required" title="required">*</abbr></label><br>
                                     <input type="text" name="txt_keyword" placeholder="Please add your site keywords separated by commas." value="<?php if(isset($keyword)) echo $keyword;?>" required/>
                                </div> 
                                <div class="rvrwrgsdv">
                                ...
                                <div class="rvrwrgsdv">
                                     ...
                                     <input type="text" name="txt_address1" placeholder="Your public business address." value="<?php if(isset($address1)) echo $address1;?>" required/>
                                     <input type="text" id="rvrw_address" name="txt_address2" placeholder="Apartment, suite, unit etc. (optional)" value="<?php if(isset($address2)) echo $address2;?>" />
                                </div> 
                                <div class="rvrwrgsdv">
    ...
    echo '</div>'; ?>
                                ...
                                <div class="rvrwrgsdv">
                                     ...
                                     <input type="text" placeholder="Your public phone number." name="txt_phone" value="<?php if(isset($phone)) echo $phone;?>" required/>
                                </div> 
                                <div class="rvrwrgsdv">
                                     <label>Email Address&nbsp;<abbr class="required" title="required">*</abbr></label><br>
                                     <input type="text" placeholder="Your public email address." name="txt_email" value="<?php if(isset($email)) echo $email;?>" required/>
                                </div> 
                                <div class="rvrwrgsdv">
                                     <label>Account Username&nbsp;<abbr class="required" title="required">*</abbr></label><br>
                                     <input type="text" placeholder="username" name="txt_account_username" value="<?php if(isset($user_name)) echo $user_name;?>" required/>
                                </div> 
                                <div class="rvrwrgsdv">
                                     <label>Create account password&nbsp;<abbr class="required" title="required">*</abbr></label><br>
                                     <input type="password" placeholder="password" name="txt_password" value="" required/>
                                </div> 
                                <div class="rvrwrgsdv">
